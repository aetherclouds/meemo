...
var createSqlite3Api = (function (module) {
  ...
  var sqlite3_close_v2 = module.cwrap("sqlite3_close_v2", "number", ["number"]);
  ...
  var sqlite3_changes = module.cwrap("sqlite3_changes", "number", ["number"]); // Prepared statements
  // prepare

  var sqlite3_prepare_v2 = module.cwrap("sqlite3_prepare_v2", "number", ["number", "string", "number", "number", "number"]); // Version of sqlite3_prepare_v2 to which a pointer to a string that is already
  // in memory is passed.

  var sqlite3_prepare_v2_sqlptr = module.cwrap("sqlite3_prepare_v2", "number", ["number", "number", "number", "number", "number"]); // Bind parameters
  ...
  var sqlite3_bind_text = module.cwrap("sqlite3_bind_text", "number", ["number", "number", "number", "number", "number"]);
  var sqlite3_bind_blob = module.cwrap("sqlite3_bind_blob", "number", ["number", "number", "number", "number", "number"]); // int sqlite3_bind_double(sqlite3_stmt*, int, double);

  var sqlite3_bind_double = module.cwrap("sqlite3_bind_double", "number", ["number", "number", "number"]); // int sqlite3_bind_double(sqlite3_stmt*, int, int);

  var sqlite3_bind_int = module.cwrap("sqlite3_bind_int", "number", ["number", "number", "number"]); // int sqlite3_bind_parameter_index(sqlite3_stmt*, const char *zName);

  var sqlite3_bind_parameter_index = module.cwrap("sqlite3_bind_parameter_index", "number", ["number", "string"]); // Get values
  // int sqlite3_step(sqlite3_stmt*)

  var sqlite3_step = module.cwrap("sqlite3_step", "number", ["number"]);
  var sqlite3_errmsg = module.cwrap("sqlite3_errmsg", "string", ["number"]); // int sqlite3_data_count(sqlite3_stmt *pStmt);

  var sqlite3_data_count = module.cwrap("sqlite3_data_count", "number", ["number"]);
  var sqlite3_column_double = module.cwrap("sqlite3_column_double", "number", ["number", "number"]);
  var sqlite3_column_text = module.cwrap("sqlite3_column_text", "string", ["number", "number"]);
  var sqlite3_column_blob = module.cwrap("sqlite3_column_blob", "number", ["number", "number"]);
  var sqlite3_column_bytes = module.cwrap("sqlite3_column_bytes", "number", ["number", "number"]);
  var sqlite3_column_type = module.cwrap("sqlite3_column_type", "number", ["number", "number"]); // const char *sqlite3_column_name(sqlite3_stmt*, int N);

  var sqlite3_column_name = module.cwrap("sqlite3_column_name", "string", ["number", "number"]); // int sqlite3_reset(sqlite3_stmt *pStmt);

  var sqlite3_reset = module.cwrap("sqlite3_reset", "number", ["number"]);
  var sqlite3_clear_bindings = module.cwrap("sqlite3_clear_bindings", "number", ["number"]); // int sqlite3_finalize(sqlite3_stmt *pStmt);

  var sqlite3_finalize = module.cwrap("sqlite3_finalize", "number", ["number"]); // Create custom functions

  var sqlite3_create_function_v2 = module.cwrap("sqlite3_create_function_v2", "number", ["number", "string", "number", "number", "number", "number", "number", "number", "number"]);
  var sqlite3_value_type = module.cwrap("sqlite3_value_type", "number", ["number"]);
  var sqlite3_value_bytes = module.cwrap("sqlite3_value_bytes", "number", ["number"]);
  var sqlite3_value_text = module.cwrap("sqlite3_value_text", "string", ["number"]);
  var sqlite3_value_int = module.cwrap("sqlite3_value_int", "number", ["number"]);
  var sqlite3_value_blob = module.cwrap("sqlite3_value_blob", "number", ["number"]);
  var sqlite3_value_double = module.cwrap("sqlite3_value_double", "number", ["number"]);
  var sqlite3_result_double = module.cwrap("sqlite3_result_double", "", ["number", "number"]);
  var sqlite3_result_null = module.cwrap("sqlite3_result_null", "", ["number"]);
  var sqlite3_result_text = module.cwrap("sqlite3_result_text", "", ["number", "string", "number", "number"]);
  var RegisterExtensionFunctions = module.cwrap("RegisterExtensionFunctions", "number", ["number"]);
  return {
    ...
    sqlite3_prepare_v2_sqlptr: sqlite3_prepare_v2_sqlptr,
...
var Module = typeof sqlite3 !== 'undefined' ? sqlite3 : {};
...
// 1) We could be the application main() thread running in the main JS UI thread. (false == false and ENVIRONMENT_IS_PTHREAD == false)
// 2) We could be the application main() thread proxied to worker. (with Emscripten -s PROXY_TO_WORKER=1) (false == true, ENVIRONMENT_IS_PTHREAD == false)
// 3) We could be an application pthread running in a worker. (false == true and ENVIRONMENT_IS_PTHREAD == true)
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'sqlite3.wast';
  var wasmBinaryFile = 'sqlite3.wasm';
  var asmjsCodeFile = 'sqlite3.temp.asm.js';
  ...
  function getBinaryPromise() {
    ...
    if (!Module['wasmBinary'] && (true) && typeof fetch === 'function') {
...
FS.staticInit();__ATINIT__.unshift(function() { if (!Module["noFSInit"] && !FS.init.initialized) FS.init(); });__ATMAIN__.push(function() { FS.ignorePermissions = false; });Module["FS_createFolder"] = FS.createFolder;Module["FS_createPath"] = FS.createPath;Module["FS_createDataFile"] = FS.createDataFile;Module["FS_createPreloadedFile"] = FS.createPreloadedFile;Module["FS_createLazyFile"] = FS.createLazyFile;Module["FS_createLink"] = FS.createLink;Module["FS_createDevice"] = FS.createDevice;Module["FS_unlink"] = FS.unlink;__ATINIT__.unshift(function() { });if (false) { var fs; var NODEJS_PATH; }DYNAMICTOP_PTR = staticAlloc(4);
...
Module['wasmTableSize'] = 6784;

Module['wasmMaxTableSize'] = 6784;
...
var createSqlJs = (function (wasmModule, Sqlite3) {
  var NULL = 0; // NULL pointer, not a JS null

  var ALLOC_NORMAL = 0; // Tries to use _malloc()

  var sqlite3_step = Sqlite3.sqlite3_step,
      ...
      sqlite3_data_count = Sqlite3.sqlite3_data_count,
      ...
      sqlite3_prepare_v2_sqlptr = Sqlite3.sqlite3_prepare_v2_sqlptr,
      sqlite3_prepare_v2 = Sqlite3.sqlite3_prepare_v2,
      sqlite3_open = Sqlite3.sqlite3_open,
      sqlite3_close_v2 = Sqlite3.sqlite3_close_v2,
      sqlite3_errmsg = Sqlite3.sqlite3_errmsg,
      sqlite3_changes = Sqlite3.sqlite3_changes,
      sqlite3_value_type = Sqlite3.sqlite3_value_type,
      sqlite3_value_int = Sqlite3.sqlite3_value_int,
      sqlite3_value_double = Sqlite3.sqlite3_value_double,
      sqlite3_value_text = Sqlite3.sqlite3_value_text,
      sqlite3_value_bytes = Sqlite3.sqlite3_value_bytes,
      sqlite3_value_blob = Sqlite3.sqlite3_value_blob,
      sqlite3_result_null = Sqlite3.sqlite3_result_null,
      sqlite3_result_double = Sqlite3.sqlite3_result_double,
      sqlite3_result_text = Sqlite3.sqlite3_result_text,
      sqlite3_create_function_v2 = Sqlite3.sqlite3_create_function_v2,
      RegisterExtensionFunctions = Sqlite3.RegisterExtensionFunctions;
  var _wasmModule$FS = wasmModule.FS,
      createDataFile = _wasmModule$FS.createDataFile,
      unlink = _wasmModule$FS.unlink,
      readFile = _wasmModule$FS.readFile;
  var HEAP8 = wasmModule.HEAP8,
      _free = wasmModule._free,
      stackAlloc = wasmModule.stackAlloc,
      getValue = wasmModule.getValue,
      setValue = wasmModule.setValue,
      intArrayFromString = wasmModule.intArrayFromString,
      allocate = wasmModule.allocate,
      stackSave = wasmModule.stackSave,
      stringToUTF8 = wasmModule.stringToUTF8,
      lengthBytesUTF8 = wasmModule.lengthBytesUTF8,
      stackRestore = wasmModule.stackRestore; //@copyright Ophir LOJKINE

  var apiTemp = stackAlloc(4); // Constants are defined in api-data.coffee
  ...
  */
    ...
    _createClass(Statement, [{
      ...
      */
      ...
      value: function getBlob(pos) {
        ...
        for (var i = 0, end = size, asc = 0 <= end; asc ? i < end : i > end; asc ? i++ : i--) {
      ...
      */
      ...
      value: function get(params) {
        ...
        return function () {
          ...
          for (var field = 0, end = sqlite3_data_count(_this.stmt), asc = 0 <= end; asc ? field < end : field > end; asc ? field++ : field--) {
            switch (sqlite3_column_type(_this.stmt, field)) {
              case SQLite.INTEGER:
              case SQLite.FLOAT:
                result.push(_this.getNumber(field));
                break;

              case SQLite.TEXT:
                result.push(_this.getString(field));
                break;

              case SQLite.BLOB:
                result.push(_this.getBlob(field));
                break;
      ...
      */
      ...
      value: function getColumnNames() {
        ...
        return __range__(0, sqlite3_data_count(this.stmt), false).map(function (i) {
          return sqlite3_column_name(_this2.stmt, i);
        });
      }
      ...
      */
      ...
      key: "bindString",
      value: function bindString(string, pos) {
        var strptr;
      ...
      key: "bindBlob",
      value: function bindBlob(array, pos) {
        var blobptr;
      ...
      key: "bindNumber",
      value: function bindNumber(num, pos) {
        if (pos == null) {
          pos = this.pos++;
        }
      ...
      key: "bindValue",
      value: function bindValue(val, pos) {
        if (pos == null) {
          pos = this.pos++;
        }
      ...
      */
      ...
      key: "bindFromObject",
      value: function bindFromObject(valuesObj) {
        for (var name in valuesObj) {
          var value = valuesObj[name];
          var num = sqlite3_bind_parameter_index(this.stmt, name);
      ...
      */
      ...
      key: "bindFromArray",
      value: function bindFromArray(values) {
      ...
      */
      ...
      value: function free() {
        this.freemem();
        var res = sqlite3_finalize(this.stmt) === SQLite.OK;
  ...
  function () {
    ...
    function Database(data) {
      ...
      if (data) {
        createDataFile('/', this.filename, data, true, true);
      }
    ...
    _createClass(Database, [{
      ...
      */
      ...
      value: function exec(sql) {
        ...
        var stack = stackSave(); // Store the SQL string in memory. The string will be consumed, one statement
        // at a time, by sqlite3_prepare_v2_sqlptr.
        // Allocate at most 4 bytes per UTF8 char, +1 for the trailing '\0'

        var nextSqlPtr = stackAlloc(sql.length << 2 + 1);
        var lengthBytes = lengthBytesUTF8(sql) + 1;
        stringToUTF8(sql, nextSqlPtr, lengthBytes); // Used to store a pointer to the next SQL statement in the string
        ...
        while (getValue(nextSqlPtr, 'i8') !== NULL) {
          ...
          var pStmt = getValue(apiTemp, 'i32'); //  pointer to a statement, or null
      ...
      */
      ...
      key: 'each',
      value: function each(sql, params, callback, done) {
      ...
      */
      ...
      value: function _export() {
        for (var _ in this.statements) {
          var stmt = this.statements[_];
          stmt['free']();
        }

        this.handleError(sqlite3_close_v2(this.db));
        var binaryDb = readFile(this.filename, {
          encoding: "binary"
        });
        this.handleError(sqlite3_open(this.filename, apiTemp));
        this.db = getValue(apiTemp, 'i32');
      ...
      */
      ...
      key: 'create_function',
      value: function create_function(name, func) {
        var wrapped_func = function wrapped_func(cx, argc, argv) {
          // Parse the args from sqlite into JS objects
          var args = [];

          for (var i = 0, end = argc, asc = 0 <= end; asc ? i < end : i > end; asc ? i++ : i--) {
              ...
              switch (false) {
                ...
                case value_type !== 4:
                  return function (ptr) {
                    ...
                    for (var j = 0, end1 = size, asc1 = 0 <= end1; asc1 ? j < end1 : j > end1; asc1 ? j++ : j--) {
            ...
            var arg = data_func(value_ptr);
            args.push(arg);
          } // Invoke the user defined function with arguments from SQLite


          var result = func.apply(null, args); // Return the result of the user defined function to SQLite
        ...
        var func_ptr = addFunction(wrapped_func);
...
var getDefaultWasmUrl = function getDefaultWasmUrl() {
  ...
  return new Promise(function (resolve, reject) {
    var wasm = sqlite3({
      ...
      onRuntimeInitialized: function onRuntimeInitialized() {
        var sqlite3Api = createSqlite3Api(wasm);
        var api = createSqlJs(wasm, sqlite3Api); // @ts-ignore
